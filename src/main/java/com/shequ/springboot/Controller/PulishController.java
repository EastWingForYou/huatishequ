...
import com.shequ.springboot.Dao.InsertQuestion;
...
public class PulishController {
    ...
    @Autowired
    private InsertQuestion insertQuestion;
    ...
    public String  doPulish(
        ...
        for (Cookie cookie : cookies) {
            if (cookie.getName().equals("token")) {
                ...
                user = insertUser.findByToken(token);
        ...
        insertQuestion.InsertHuati(question);
        return "redirect:/";
    }
}
